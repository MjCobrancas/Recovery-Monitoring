...
export function TableSchedule({ schedules, filter }: IScheduleTable) {
    ...
    function handleGetLengthOfFilter() {
    ...
    return (
        <section className={`relative max-h-[24.8rem] overflow-y-auto px-2 mt-8`}>
            <div className="absolute font-medium -top-1 right-1">{handleGetLengthOfFilter()} resultados encontrados.</div>
            <div>
                <table className={`w-full px-4 mx-auto my-4`}>
